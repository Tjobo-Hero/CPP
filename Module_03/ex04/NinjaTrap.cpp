...
NinjaTrap::~NinjaTrap(void)
{
	std::cout << this->getName() << " died with honor. And will be added to the Ninja Wall of Fame.\n" << std::endl;
	return;
}
...
unsigned int		NinjaTrap::getEnergyPoints(void)
{
	return _energyPoints;
}
unsigned int		NinjaTrap::getMaxEnergyPoints(void)
{
	return _maxEnergyPoints;
}
unsigned int		NinjaTrap::getMeleeAttackDamage(void)
{
