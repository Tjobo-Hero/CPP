...
void	FragTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "FR4G-TP [" << _name << "] is being attacked at this very moment." << std::endl;
	if (amount <= _armorDamageReduction)
	{
		std::cout << "FR4G-TP [" << _name << "] deflected the attack. Better luck next time.\n" << std::endl;
		return;
	}
	...
	{
		this->_hitPoints = 0;
		std::cout << "FR4G-TP [" << _name << "] has DIED. OMG call your mama.\n" << std::endl;
		return;
	}
	std::cout << "FR4G-TP [" << _name << "] has taken [" << amount << "] damage.\nFR4G-TP [" << _name << "] has ["<< _hitPoints << "] Hit Points left.\n" << std::endl;
	return;
}
...
void	FragTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << "FR4G-TP [" << _name << "] has been repaired for: [" << amount << "]. FR4G-TP [" << _name << "] has [" << _hitPoints << "] Hit Points left.\n" << std::endl;
	return;
}
...
void	FragTrap::re_energize(unsigned int amount)
{
	...
	std::cout << "FR4G-TP [" << _name << "] has been re-energize for: [" << amount << "]. FR4G-TP [" << _name << "] has [" << _energyPoints << "] Energy Points left.\n" << std::endl;
	return;
}
...
void	FragTrap::vaulthunter_dot_exe(std::string const &target)
{
	...
	{
		std::cout << "FR4G-TP [" << _name << "] has not enough energy to call this attack. Boohooooo." << std::endl;
	...
	std::cout << "This special attack has cost 25 of Energy Points FR4G-TP [" << _name << "] now has Energy Points: [" << _energyPoints << "] left.\n" << std::endl;
	return;
}
