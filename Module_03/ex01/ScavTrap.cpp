...
ScavTrap::ScavTrap(void) : _hitPoints(100), _maxHitPoints(100), _energyPoints(50), _maxEnergyPoints(50), _level(1), _name(""), _meleeAttackDamage(20), _rangedAttackDamage(15), _armorDamageReduction(3)
{
...
ScavTrap::ScavTrap(std::string Name) : _hitPoints(100), _maxHitPoints(100), _energyPoints(50), _maxEnergyPoints(50), _level(1), _name(Name), _meleeAttackDamage(20), _rangedAttackDamage(15), _armorDamageReduction(3)
{
	...
	std::cout << "SC4V-TP character [" << this->_name << "] was created. Good luck on your journey.\nDo a little dance or the CHA-CHA.....\n" << std::endl;
	return;
}

ScavTrap::~ScavTrap(void)
{
	std::cout << "SC4V-TP [" << this->_name << "] did not survive. It will not be remembered.\n" << std::endl;
	return;
}
...
ScavTrap::ScavTrap(ScavTrap const &src)
{
	...
	*this = src;
	std::cout << "SC4V-TP [" << this->_name << "] has screened and copied. Enjoy this simbiosis you share.\n" << std::endl;
	return;
}
...
ScavTrap&		ScavTrap::operator=(ScavTrap const &other)
{
	...
	std::cout << "SC4V-TP [" << _name << "] transfered.\n" << std::endl;
	return *this;
}
...
void	ScavTrap::rangedAttack(std::string const &target)
{
	...
	std::cout << "SC4V-TP [" << this->_name << "] attacks [" << target << "] from far away. Reslting in [" << this->_rangedAttackDamage << "] points of damage! Oh Yeah!\n" << std::endl;
	return;
}
...
void	ScavTrap::meleeAttack(std::string const &target)
{
	...
	std::cout << "SC4V-TP [" << this->_name << "] attacks [" << target << "] from up close, doing [" << this->_meleeAttackDamage << "] points of damage!\n" << std::endl;
	return;
}
...
void	ScavTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "SC4V-TP [" << _name << "] is under attacked." << std::endl;
	if (amount <= _armorDamageReduction)
	{
		std::cout << "SC4V-TP [" << _name << "] shields ability deflected the incoming attack. You lose.\n" << std::endl;
		return;
	}
	...
	{
		this->_hitPoints = 0;
		std::cout << "SC4V-TP [" << _name << "] is no more.... It will not be remembered.\n" << std::endl;
		return;
	}
	std::cout << "SC4V-TP [" << _name << "] took [" << amount << "] points of damage.\nSC4V-TP [" << _name << "] has ["<< _hitPoints << "] Hit Points left.\n" << std::endl;
	return;
}
...
void	ScavTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << "SC4V-TP [" << _name << "] has been repaired for: [" << amount << "]. SC4V-TP [" << _name << "] has [" << _hitPoints << "] Hit Points left. And is ready to rumble.\n" << std::endl;
	return;
}
...
void	ScavTrap::re_energize(unsigned int amount)
{
	...
	std::cout << "SC4V-TP [" << _name << "] has got fresh new energy for: [" << amount << "]. SC4V-TP [" << _name << "] has [" << _energyPoints << "] Energy Points left. Use your special function called challangeNewcomer.\n" << std::endl;
	return;
}
...
void	ScavTrap::challengeNewcomer(std::string const &target)
{
	...
	{
		std::cout << "SC4V-TP [" << _name << "] has insufficient energy level. Please come back when you have more energy. Tip: use the re_energize function.\n" << std::endl;
		return;
	}
	randomNum = rand() % 5;
	...
	std::cout << "SC4V-TP [" << _name << "] used 25 Energy Points for the special attack. Energy Points: [" << _energyPoints << "] left.\n" << std::endl;
	return;
}
